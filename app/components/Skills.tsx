  ...
  const skillCategories = [
    {
      icon: <Code size={24} />,
      title: "Frontend",
      skills: ["HTML", "CSS", "JavaScript", "TypeScript", "React", "NextJS", "TanStack Query", "Zustand", "ShadcnUI", "TailwindCSS", "Vite"]
    },
    {
      icon: <Database size={24} />,
      title: "Backend",
      skills: ["Node.js", "Express", "MongoDB", "PostgreSQL", "Prisma", "NextAuth", "JWT", "RESTful APIs"]
    },
    {
      icon: <Globe size={24} />,
      title: "Web Technologies",
      skills: ["Git", "GitHub", "AWS", "Vercel", "Azure Blob Storage", "GitHub Actions", "Responsive Design"]
    },
    {
      icon: <Wrench size={24} />,
      title: "Tools & Others",
      skills: ["Docker", "Turborepo", "Monorepo", "CI/CD", "Figma", "Postman", "System Design", "Problem Solving", "Open Source"]
    }
  ]

  const education = [
    {
      logo: "/100xDevs-DS2rVXd9.png",
      title: "100xDevs",
    ...
    {
      logo: "/assam-university-logo-29-03-2017.jpg",
